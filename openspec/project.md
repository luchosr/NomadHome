...
5. **`docs/PRD.md`** — authoritative for _why_ (business motivation, personas, success metrics); never authoritative for _what the system does_ at the requirement level
